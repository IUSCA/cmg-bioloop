...
class CMGLogMigrationManager:
    ...
    def __init__(self, pg_conn_env_vars: dict):
        ...
        Args:
            pg_conn_env_vars: PostgreSQL connection environment variables
            cmg_project_path: Base path to CMG project for finding log files
        """
        # self.cmg_project_path = cmg_project_path
    ...
    def find_cmg_log_file(self, dataset_name: str) -> Optional[str]:
        ...
        Searches multiple possible paths where CMG log files might be located.
    ...
    def safe_migrate_conversion(self, conversion: dict, log_content: str, dataset_name: str) -> Tuple[bool, int]:
        """
        Safely migrate a single conversion with error handling.
    ...
    def migrate_cmg_conversion_logs(self):
        ...
        for dataset_id, conversions in conversions_by_dataset.items():
            ...
            for conversion in conversions:
                ...
                success, log_count = self.safe_migrate_conversion(conversion, log_content, dataset_name)
