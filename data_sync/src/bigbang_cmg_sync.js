...
Options:
  ...
  --clear-target-db           Clear all CMG- and Xenium-originated rows (schema preserved)
...
Examples:
  ...
  # Clear all legacy migration rows and run fresh CMG migration
...
async function main() {
  ...
  try {
    ...
    logger.info('[5/17] Seeding import sources and About content...');
