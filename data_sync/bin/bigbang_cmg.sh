...
#   --clear-cmg-target-data Clear CMG-originated data from target DB before migration
...
#
#   # Clear CMG-originated data before migration
#   ./bin/bigbang_cmg.sh --target-db sandbox --clear-cmg-target-data
#
