# bigWig_H1hESC_H3K27ac_hg19_ENCODE - H3K27ac ChIP-seq Signal Track

## Dataset Overview

**File:** `wgEncodeBroadHistoneH1hescH3k27acStdSig.bigWig`  
**Source:** UCSC ENCODE (Broad Institute)  
**URL:** https://hgdownload.cse.ucsc.edu/goldenPath/hg19/encodeDCC/wgEncodeRegMarkH3k27ac/wgEncodeBroadHistoneH1hescH3k27acStdSig.bigWig  
**Size:** 652 MB  
**Format:** BigWig  
**Genome:** hg19  
**Cell Line:** H1-hESC (Human Embryonic Stem Cells)  
...
**UCSC ENCODE Project**  
https://hgdownload.cse.ucsc.edu/goldenPath/hg19/encodeDCC/wgEncodeRegMarkH3k27ac/

Broad Institute H3K27ac ChIP-seq data from ENCODE project for H1-hESC cells.  
High-quality reference data for testing epigenomic visualization and regulatory element mapping.
