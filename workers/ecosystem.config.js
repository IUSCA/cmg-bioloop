...
module.exports = {
  ...
  apps: [
    ...
    },
    {
      ...
      script: "python",
      args: "-m celery -A workers.conversions_app worker --loglevel INFO -O fair --pidfile conversions_worker.pid --hostname 'cmg-test-celery-w1@%h' --autoscale=8,2 --queues 'conversion.cmg-test.sca.iu.edu.q' --statedb=conversions_worker_state.db",
      watch: false,
      interpreter: "",
      log_date_format: "YYYY-MM-DD HH:mm Z",
