...
#
# Note:
#   - This script creates detailed documentation in ../product_docs/bigWig_GSM429321_H3K27ac_hg19.md
#
# =============================================================================
...
DIR_NAME="bigWig_GSM429321_H3K27ac_hg19"
...
```
/opt/sca/data/origin/data_products/bigWig_GSM429321_H3K27ac_hg19/
```
